defmodule VibetodoWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use VibetodoWeb.ConnCase, async: true`, although
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Vibetodo.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
