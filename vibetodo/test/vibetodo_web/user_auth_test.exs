defmodule VibetodoWeb.UserAuthTest do
  use VibetodoWeb.ConnCase

  alias Vibetodo.Accounts
  alias Vibetodo.Accounts.Scope
  alias VibetodoWeb.UserAuth

  import Vibetodo.AccountsFixtures

  @remember_me_cookie "_vibetodo_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, VibetodoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
